        ...
        <div class="login-card fade-in">
            ...
            <div class="form-container">
                ...
                <div class="welcome-text">
                    <h2>Welcome Back!</h2>
                    <p>Access your account and start earning</p>
                </div>
                ...
                <form action="{{ route('user.login') }}" method="post" class="login-form" id="loginForm">
                    ...
                    <div class="form-group">
                        <div class="input-wrapper" id="emailWrapper">
                            ...
                            <input type="email" name="username" value="{{ old('email') }}" 
                    ...
                    <!-- Register Button -->
                    <button type="button" class="btn-secondary" onclick="window.location.href='{{route('user.register')}}'">
