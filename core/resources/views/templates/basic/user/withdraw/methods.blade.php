@include($activeTemplate . 'partials.headers')
   ...
   <style>
    ...
    .banner { width: 100%; height: fit-content; background: linear-gradient(90deg,#3d4349,#7d2b73); border-radius: 10px 10px 0 0; padding: 30px 0; }
    ...
    .amt-sets button.btn-amt.active { background-color: #3d4349; }
    ...
    form.login-form button.btn.btn-submit { width: 100%; height: 45px; font-size: 14px; font-weight: 400; color: #fff; background: linear-gradient(90deg,#3d4349,#363636); border: 0px; border-radius: 25px; padding: 0; margin: 20px 0; }
    ...
    .rule-txt p { font-size: 15px; font-weight: 700; line-height: 22px; color: #3d4349; margin-bottom: 15px; }
</style>
