...
<style>
    ...
    .header { width: 100%; max-width: 991px; height: 50px; padding: 0 15px; background: #3d4349; display: flex; flex-direction: row; align-items: center; justify-content: space-between; position: fixed; transform: translateX(-50%); left: 50%; top: 0; z-index: 100; }
    ...
    .modal.load-modal .modal-content button.btn.btn-view { width: 240px; height: 45px; border: 0; border-radius: 25px; outline: 0; box-shadow: none; background: linear-gradient(90deg,#363636,#363636); padding: 0; font-size: 16px; font-weight: 400; color: #fff; }
</style>
